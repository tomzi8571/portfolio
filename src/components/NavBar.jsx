...
export default function NavBar() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-base-100/80 backdrop-blur border-b border-base-300">
      <div className="section">
        <div className="navbar px-0 h-16">
          ...
          <div className="navbar-end gap-3">
            ...
            {/* Theme chooser dropdown for other themes */}
            <div className="dropdown dropdown-end">
              <label tabIndex={0} className="btn btn-sm">Theme</label>
              <ul tabIndex={0} className="dropdown-content menu menu-sm bg-base-200 rounded-box z-[1] mt-2 w-44 p-2 shadow">
                {themes.map((t) => (
                  <li key={t}>
                    <input
                      type="radio"
